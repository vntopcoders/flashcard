import { lessonDb, flashcardDb } from '../src/lib/supabase'
...
async function importIELTSData() {
  try {
    ...
    console.log('✅ IELTS data import completed successfully!')
    console.log(`Imported ${ieltsLevel1Data.length} flashcards across ${createdLessons.length} lessons`)
